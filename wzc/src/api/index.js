...
export const deleteUserApi = (id) => request.delete("/manager/user/detail/" + id)


export const getApprovalsApi = (keyword) => request.get("/manager/cj-list", { keyword })
export const passJobApi = (id, params) => request.post("/manager/verify/job/" + id, params)
export const passCompApi = (id, params) => request.post("/manager/verify/company/" + id, params)

export const deleteCommentApi = (params) => request.delete("/manager/comment/detail", params)
export const publishCommentApi = (id, params) => request.post("/jobs/" + id + "/comment-area", params)
...
export const createCompApi = (params) => request.post("company/cp-list", params)
export const uploadCompLogoApi = (params) => request.post("company/cp/picture", params)
export const getCompInfoApi = (id) => request.get("company/detail", { id })

export const getAppliesUserApi = () => request.get("auth/user/apply")
export const getAppliesEmployerApi = () => request.get("auth/user/apply-employer")
...
export const passUserApplyApi = (id, status) => request.put("/jobs/apply-detail/" + id, { status })
