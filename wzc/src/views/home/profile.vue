		...
		<n-row :gutter="30">
			<n-col :span="16">
				<div class="flex justify-between items-center">
					...
					<n-button type="success" class="mr-5" @click="showEditProfile = true"
						>编辑个人信息</n-button
					>
				</div>
				<div>
							...
							<div class="flex items-center">
								...
								<div class="px-5">
									<div>
										...
										<span class="text-xl leading-none opacity-50">
											给您发送了通知:</span
										>
									</div>
									<p class="text-xl leading-4 pt-2 italic opacity-70">
										{{ item.content }}
									</p>

									<div
										class="mt-2 text-[#797979] text-[15px] font-medium opacity-75"
									>
